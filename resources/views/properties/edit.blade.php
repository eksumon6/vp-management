...
@section('content')
  <div class="d-flex align-items-center gap-2 mb-3">
    <h1 class="h4 text-success mb-0"><i class="bi bi-pencil-square"></i> সম্পত্তি সম্পাদনা</h1>
    <a href="{{ route('properties.index') }}" class="btn btn-outline-success"><i class="bi bi-arrow-left"></i> তালিকায় ফিরুন</a>
  </div>
  <div class="card p-3">
